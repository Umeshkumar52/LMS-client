...
export default function Home({children}){
  ...
  <div className='w-full h-cover bg-[#060316] flex flex-col items-center py-6 justify-center gap-16 '>
   <div className='w-full px-1 flex flex-col items-center justify-center gap-16 pt-10 lg:pt-16 md:flex-row lg:flex-row lg:p-10'>
     <div className='flex justify-center items-center flex-col gap-5'>
      <div className='flex flex-col gap-3 justify-center'>
         <h1 className=' lg:text-3xl w-[16rem] lg:w-[20rem] text-2xl font-bold text-white'>
        ...
        <div className='flex gap-5 '>
            <button className='bg-yellow-400 font-normal rounded-xl px-1 text-lg py-1 text-white border-4 border-white'><Link to='ExploreCourses'>ExploreCourses</Link></button>
            <button className='focus-current text-white font-normal px-1 text-lg py-1 rounded-xl border-4 border-yellow-400'><Link to='ContactUs'>ContactUs</Link></button>
        </div>
      </div>
     </div>
...
{/* paragraph */}
 ...
 {/* detailed our course */}
 <div className='w-full flex flex-wrap gap-8 px-1 justify-center items-center'>
...
<div className='flex flex-col justify-center items-center gap-4 w-full'>
   <div className=' w-full flex flex-col text-white justify-center items-center gap-4'>
      <h1 className='text-3xl text-slate-300 font-bold'>Our Courses</h1>
      <h2 className='text-lg font-serif'>Practice-Based Learning Tracks, <span className='text-red-500 text-xl'>Superchanged By A.I.</span></h2>
   </div>
...
<div className='mx-1 rounded-xl p-1 shadow-green-500 shadow-lg bg-gradient-to-l from-green-700 to-green-100  flex flex-col justify-center items-center'>
   ...
   <p className='text-xl font-sarif text-black '>If you are sturding in college, check courses offer by prepleaf. <Link className='text-red-500'>Click Here</Link></p>
    ...
    <div className=' flex flex-col justify-center items-center gap-4'>
       ...
       <div className="carousel w-[260px] gap-4 lg:w-[150vh] xl:w-[220vh] overflow-y-hidden rounded flex">
  <div id="item1" className="carousel-item h-20 w-[250px]">
  ...
  <div id="item2" className="carousel-item h-20 w-[250px]">
  ...
  <div id="item3" className="carousel-item h-20 w-[250px]">
...
{/* Success Stories */}
    <div>
     <div className='flex flex-col items-center justify-center gap-4'>
      ...
      <div className="carousel mx-1 overflow-y-hidden w-[260px] px-4 gap-4 lg:w-[135vh] 2xl:w-full flex rounded  h-[18rem]">
  <div id="item1" className="carousel-item px-2 border-2 rounded-xl border-slate-600  overflow-y-hidden w-[240px] lg:w-[60vh] border-6  flex flex-col items-center">
  ...
  <div id="item2" className="carousel-item px-2 border-2 rounded-xl border-slate-600 p-2 overflow-y-hidden  w-[240px] lg:w-[60vh] flex flex-col items-center">
  ...
  <div id="item3" className="carousel-item px-2 border-2 rounded-xl border-slate-600 p-2 overflow-y-hidden w-[240px] lg:w-[60vh] flex flex-col items-center">
  ...
  <div id="item4" className="carousel-item px-2 border-2 rounded-xl border-slate-600 p-2 overflow-y-hidden w-[240px] lg:w-[60vh] flex flex-col items-center">
