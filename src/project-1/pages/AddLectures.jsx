...
export default function AddLectures() {
  ...
  return (
    <div className='flex flex-col pt-10 justify-center items-center h-screen w-full'>
    {(!isLoading)?
      <form encType='multipart/form-data' className='flex flex-col items-center gap-2 w-[100vh] px-10 py-3 rounded-lg text-white font-serif bg-[#2d2d31eb] '>
       <h1 className='font-semibold text-2xl'>Add Lectures</h1>
      ...
      <label htmlFor='addLectures' className='w-full'><div className='flex items-center justify-center border-slate-700 border-4 rounded py-6 w-full'>Upload Lecture</div>
