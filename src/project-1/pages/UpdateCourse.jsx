...
export default function UpdateCourse() {
  ...
  return (
    ...
    {(!isLoading)?
    <form onSubmit={up} className='flex flex-col justify-center items-center font-serif rounded border-1 gap-4 text-white bg-[#2d2d31eb] w-[16rem] h-fit lg:w-[50%]'>
     ...
     <div className=' flex flex-col justify-center items-center gap-2 '>
      ...
      <label htmlFor='description' >Description<br/>
        ...
        <button className='border-2 bg-blue-700 rounded-md px-2 py-1 text-white font-bold  w-[70vh]'>update Course</button>
        </div>
    </form>
    :<LoadingSpiner/>
    }
